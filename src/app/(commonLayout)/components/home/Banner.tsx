  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        >
          A community-driven platform for passionate home cooks and professional
          chefs to share, explore, and master new recipes. Join now and start
          cooking with Chef;s Circle.
        </p>
