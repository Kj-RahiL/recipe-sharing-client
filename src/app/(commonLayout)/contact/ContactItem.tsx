...
const ContactItems = () => {
  ...
  return (
    <div className={`py-20 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
      <div className="py-10">
        {/* Heading */}
        <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center text-[#003039]">
          Contact Us
        </h2>
        </div>
        ...
        {/* Form Section */}
        <h2 className="text-center text-4xl py-10 text-[#003039] font-semibold">
        ...
        <div className="flex flex-col md:flex-row justify-center items-start container mx-auto mt-10 px-4 lg:px-0">
          ...
          <div className="w-full md:w-1/2 mt-5 md:mt-0">
            <form className="space-y-6 w-full">
              ...
              <button
                type="submit"
                className="bg-[#003039] text-white py-3 px-6 rounded-md hover:bg-[#005f5f] transition duration-300"
              >
                SEND MESSAGE
              </button>
            </form>
